...
namespace AKotschevar2C1
{
    public partial class Form1 : Form
    {
        ...
        private void input2TextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            //try
            //{
            //    char1 = Convert.Tochar(input1TextBox.Text);
            //    char1TextBox.Text = char1.ToString();
            //}
            //catch (Exception) { char1TextBox.Text = "error"; }
            //try
            //{
            //    bool1 = Convert.Tobool(input1TextBox.Text);
            //    bool1TextBox.Text = bool1.ToString();
            //}
            //catch (Exception) { bool1TextBox.Text = "error"; }
