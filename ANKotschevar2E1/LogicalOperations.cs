...
namespace ANKotschevar2E1
{
        public class LogicalOperations
    {
        ...
        {
            return (member == true) || (price++ != 24.99m) || (weight <= 1.1);
        }
        public static bool q12(bool member, decimal price, float weight)
        {// 
            return member == true && (price++ != 25) && (weight >= 0.99);
        }
        public static bool q13(string shipState, string itemType)
        {
            return shipState == "MN" || ((itemType == "clothing" && itemType != "food") || itemType != "Electonics");
        }
